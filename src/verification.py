...
class ProofAndVerification(Slide):
    def construct(self):
        ...
        graph = Tex(r"$\blacktriangleright$", r" The $D_{14}$ graph", font_size=36)
        ...
        group = VGroup(graph, center_6, plus, sym, cube_and_conquer, alod_clauses).next_to(to_prove, DOWN, buff=1.2*MED_LARGE_BUFF)
